    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-44 m-0
            ...
            <div className="ml-2 space-y-8">
                ...
                <h3 className="hover:text-teal-500"><Link href="/dashboard/tickets">Tickets</Link></h3>
                <h3 className="hover:text-teal-500"><Link href="/dashboard/admin">Administration</Link></h3>
            </div>
